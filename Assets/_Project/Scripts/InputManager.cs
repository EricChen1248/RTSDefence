...
namespace Scripts
{
    ...
    public Resource selectedObject;
    private object_info selectedInfo;
    ...
    public void LeftClick(){
        ...
        if(Physics.Raycast(ray,out hit, 100)){
            if(hit.collider.tag == "Ground"){
                ...
                selectedInfo = selectedObject.GetComponent<object_info>();
    ...
    void MoveCamera(){
        ...
        if(Input.GetKey(KeyCode.W) || xPos < Screen.height && yPos > Screen.height-panDetect){
            moveZ += panSpeed;
        }
